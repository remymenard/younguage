...
![Monet and the high-level *Marketing Technology* flow](https://cdn-images-1.medium.com/max/2166/0*CafLBZiEtz9uwO62)*Monet and the high-level *Marketing Technology* flow*
...
![Architecture before and after GraphQL](https://cdn-images-1.medium.com/max/2000/1*pmh-VimZJJindIJUyZtyzg.png)*Architecture before and after GraphQL*
...
![The flexibility of the GraphQL data model to represent different views from the same underlying data](https://cdn-images-1.medium.com/max/2000/1*Tr-cnrbTOPKkWkshYpQeIA.png)*The flexibility of the GraphQL data model to represent different views from the same underlying data*
...
![Type safety from database to backend to client code](https://cdn-images-1.medium.com/max/2000/1*YLL0aFFgcGDXFEa-V9_LPA.png)*Type safety from database to backend to client code*
...
![Adding a cache to simplify data access from resolvers](https://cdn-images-1.medium.com/max/2038/1*FZCtNPL4bXS6jpgVZx0RYg.png)*Adding a cache to simplify data access from resolvers*
...
![Visualization of our GraphQL Schema](https://cdn-images-1.medium.com/max/2000/1*T3KO2GOY6EhoWUdQw8zuLQ.png)*Visualization of our GraphQL Schema*
...
If you’ve made this thus far and you’re also interested in joining the Netflix Marketing Technology team to help conquer our unique challenges, check out the [open positions](https://sites.google.com/netflix.com/adtechjobs/ad-tech-engineering) listed on our page. ***We’re hiring!***
